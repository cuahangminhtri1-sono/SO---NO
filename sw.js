/* ============================================================
   ...
   Lần này: v5 -> v6  để đẩy bản vá KHO CỨU HỘ OFFLINE của Sổ Nợ + Bán Hàng.
   Đổi VER thì máy khách mới hiện thanh "Cập nhật ngay" và tải trang mới.
   Kèm 2 bổ sung nhỏ, AN TOÀN cho mọi app (thiếu file thì tự bỏ qua):
     • nạp sẵn thêm './indexSNBH.html'
     • khi mất mạng, thử thêm './indexSNBH.html' trong danh sách dự phòng
   ============================================================ */
const VER   = 'v6';
